...
<div class="widget first">
	...
	<ul class="inact_tabs">
	    ...
	    <li class="activeTab"><a href="index.php?do=settings&sub=language&cp={$sess}">{#SETTINGS_LANG_EDIT#}</a></li>
...
<tbody>
	...
	<tr>
		...
		<td></td>
		<td align="center">
			<a class="topleftDir icon_sprite ico_edit" title="{#SETTINGS_LANG_AEDIT#}" href="javascript:void(0);" onclick="cp_pop('index.php?do=settings&sub=language&func=editlang&Id={$lang.Id}&pop=1&cp={$sess}','800','400','1','settings');"></a>
		</td>
		<td align="center">
...
<div class="rowElem">
	<input type="submit" class="basicBtn" value="{#SETTINGS_LANG_ADD#}" onclick="cp_pop('index.php?do=settings&sub=editlang&pop=1&cp={$sess}','800','400','1','settings');" />
</div>
