	...
	***************************/
	...
	$.fn.jqTransSelect = function(){
		return this.each(function(index){
			var $select = $(this);
			if($select.hasClass('NonStyle')) {return false;}
			...
			if($select.attr('disabled')){$wrapper.prepend('<div><span class="disabled"></span><a href="#" class="jqTransformSelectOpen"></a></div><ul></ul>');}
