...
class FCKeditor
{
	 ...
	 * @return string
	 */
	public function CreateHtml($aid='')
	{
		...
		if ( $this->IsCompatible() )
		{
			...
			$Html .= "<a name=\"$aid\"></a><div id=\"feld_$aid\"><iframe id=\"{$this->InstanceName}___Frame\" src=\"{$Link}\" width=\"{$this->Width}\" height=\"{$this->Height}\" frameborder=\"0\" scrolling=\"no\"></iframe></div>" ;
		}
		else
		{
