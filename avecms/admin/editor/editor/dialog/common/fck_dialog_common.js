...
{
	window.open('../../../index.php?do=docs&action=showsimple&selurl=1&target='+target+'&pop=1','pop','left=0,top=0,width='+(screen.width * 0.6)+',height='+(screen.height * 0.6)+',scrollbars=1,resizable=1');
}
